        ...
        <div class="col-md-8">
            <div class="card bg-dark text-light border-secondary">
                ...
                <div class="p-3 border-bottom border-secondary">
                    <button class="btn btn-sm btn-info" onclick="window.open('<?= $base ?>torneiosuico/verPareamento/<?= $torneio['id_torneio'] ?>/<?= $rodada['numero_rodada'] ?>','_blank')">
                    ...
                    <?php if ($rodada['numero_rodada'] > 1 || $todasConcluidas): ?>
                        <button class="btn btn-sm btn-success" onclick="window.open('<?= $base ?>torneiosuico/verPontuacao/<?= $torneio['id_torneio'] ?>','_blank')">
                ...
                <div class="card-body">
                        ...
                        <div class="p-3 mb-3 border border-secondary rounded bg-black">
                            ...
                            <div class="mt-3 text-center border-top border-secondary pt-2">
                                <?php if (!$partida['resultado']): ?>
                                    <form action="<?= $base ?>torneiosuico/salvarResultado" method="POST" class="btn-group">
                    ...
                    <div class="mt-4 text-center">
                        <?php if ($podeGerarProxima): ?>
                            <a href="<?= $base ?>torneiosuico/proximaRodada/<?= $torneio['id_torneio'] ?>" class="btn btn-warning btn-lg shadow fw-bold">
                        ...
                        <?php elseif ($todasConcluidas && $rodada['numero_rodada'] == $totalRodadas): ?>
                            <a href="<?= $base ?>torneiosuico/proximaRodada/<?= $torneio['id_torneio'] ?>" class="btn btn-danger btn-lg shadow fw-bold">
                                ENCERRAR TORNEIO
                            </a>
                        <?php endif; ?>
                    </div>
